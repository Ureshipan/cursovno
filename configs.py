...
blocks
(
    hex (24 39 26 25 0 15 2 1) (10 5 1) simpleGrading (1 1 1) // 1
    hex (39 38 27 26 15 14 3 2) (10 5 1) simpleGrading (1 1 1) // 2
    
    hex (38 40 41 27 14 16 17 3) (5 5 1) simpleGrading (1 1 0.1) // 3
    hex (38 37 43 40 14 13 19 16) (5 5 1) simpleGrading (1 1 0.1) // 4
    hex (41 42 28 27 17 18 4 3) (5 5 1) simpleGrading (1 1 0.1) // 5
    hex (43 37 28 42 19 13 4 18) (5 5 1) simpleGrading (1 1 0.1) // 6
    
    hex (37 36 29 28 13 12 5 4) (10 5 1) simpleGrading (1 1 1) // 7
    
    hex (36 44 45 29 12 20 21 5) (5 5 1) simpleGrading (1 1 0.1) // 8
    hex (36 35 47 44 12 11 23 20) (5 5 1) simpleGrading (1 1 0.1) // 9
    hex (45 46 30 29 21 22 6 5) (5 5 1) simpleGrading (1 1 0.1) // 10
    hex (47 35 30 46 23 11 6 22) (5 5 1) simpleGrading (1 1 0.1) // 11
    
    hex (35 34 31 30 11 10 7 6) (10 5 1) simpleGrading (1 1 1) // 12
    hex (34 33 32 31 10 9 8 7) (10 5 1) simpleGrading (1 1 1) // 13
);
